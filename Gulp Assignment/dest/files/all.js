...
-->
    <!-- https://ninjasfiles.s3.amazonaws.com/asset_0000000000000024_1550237299_codezen.png -->
    <!-- https://ninjasfiles.s3.amazonaws.com/asset_0000000000000020_1549743985_macbook_mouse.jpg -->
    <!-- https://ninjasfiles.s3.amazonaws.com/asset_0000000000000030_1550710829_ninjasicon.png -->
    ...
    <div class="d-flex justify-content-center container main-div">
      <div class="row">
        <div
          class="col-12 mx-auto card bg-info text-light text-center mt-3 mb-3 xsmbrkpnt"
        >
          <div class="card bg-secondary text-light mb-3 mt-3">
            <div class="card-body">
              <h1 class="card-title">Coding Ninjas</h1>
            </div>
          </div>
          <div class="card-body">
            <h5 class="card-title">
              Think, Create &amp; Innovate.” That's the power of programming. Be
              a Ninja and build your own world.
            </h5>
            <p class="card-text">
              We strive for teaching most up-to-date programming technologies.
              Our dynamic curriculum has been designed and refined by our
              founding members-a team of seasoned software developers and tech
              executives. We strive for teaching most up-to-date programming
              technologies. Our dynamic curriculum has been designed and refined
              by our founding members-a team of seasoned software developers and
              tech executives.
            </p>
          </div>
        </div>
        ...
        <div class="col-lg-3 offset-md-3 col-md-9 ">
          <div class="card text-center mb-3" style="width: 18rem;">
            <div class="card-body">
              <h5 class="card-title">Special title treatment</h5>
              <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
